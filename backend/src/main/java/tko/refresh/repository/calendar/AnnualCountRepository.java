...
public interface AnnualCountRepository extends JpaRepository<AnnualCount, Long> {
    ...
    int setAnnualSumCount(@Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate,
                          @Param("uid") UUID uid);
    ...
    int setAnnualSubCount(@Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate,
                          @Param("uid") UUID uid);
}