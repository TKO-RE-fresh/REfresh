        ...
        <h3 class="normal-case text-3xl font-bold text-center">사원 생성</h3>
          <div class="flex flex-col m-2">
            <label class="text-gray-700 font-bold mb-2 text-xl">사원명</label>
                <input type="text" autocomplete="off" class="shadow border rounded py-2 px-3 font-bold text-xl text-gray-700 focus:outline-none focus:ring focus:border-blue-50" placeholder="사원명을 입력하세요.">
          </div>
          <div class="flex flex-col m-2">
            ...
            <input id="memberId" name="memberId"
                   ...
                   type="text" autocomplete="off" placeholder="아이디를 입력하세요.">
          </div>
          <div class="flex flex-col m-2">
            <label class="text-gray-700 font-bold mb-2 text-xl">비밀번호</label>
            <input th:field="*{memberPassword}"
                   class="shadow border rounded py-2 px-3 text-gray-700 focus:outline-none focus:ring focus:border-blue-50"
                   type="password" autocomplete="off" placeholder="비밀번호를 입력하세요.">
          </div>
          <div class="flex flex-col m-2">
            ...
            <select th:field="*{departmentName}"
                ...
                <option v-for="(deptName, idx) in department" :key="idx">{{ deptName }}</option>
            </select>
          </div>
          <div class="flex flex-col m-2">
            ...
            <input 
                   class="shadow border rounded py-2 px-3 text-gray-700 focus:outline-none focus:ring focus:border-blue-50"
                   type="number" autocomplete="off" placeholder="연차 개수를 입력하세요.">
          </div>
          <div class="flex flex-col m-2">
          ...
          <div class="flex flex-col m-2">
            ...
            <input th:field="*{memberCellphone}"
                   class="shadow border rounded py-2 px-3 text-gray-700 focus:outline-none focus:ring focus:border-blue-50"
                   type="text" autocomplete="off" placeholder="010-xxxx-xxxx">
          </div>
          <div class="flex flex-col m-2">
