    ...
    <transition name="fade">
      <div>
        <div class="fixed inset-0 z-10 flex items-center justify-center">
          <div
            class="w-full h-96 max-w-lg p-3 relative mx-auto my-auto rounded-xl shadow-lg bg-white"
          >
            <main class="relative h-full">
              <div class="flex justify-center space-x-10">
                ...
                <div v-show="select === 1">
                  <calendar-search-member> </calendar-search-member>
                </div>
              </div>
              ...
              <div
                class="absolute bottom-4 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center md:block"
              >
                <button
...
const emit = defineEmits(["closeSearchEvent"]);
function closeEvent() {
